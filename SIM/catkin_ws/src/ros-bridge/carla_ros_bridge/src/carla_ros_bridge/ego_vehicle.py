...
class EgoVehicle(Vehicle):
    ...
    def __init__(self, carla_actor, parent, node, vehicle_control_applied_callback):
        ...
        #self.collision_flag_subscriber = rospy.Subscriber(
        #    "/carla/ego_vehicle/collsion_flag",
        #    Bool, self.collision_flag_updated) #s, collision_flag subscriber for vehicle_status.velocity == 0
    ...
    #def collision_flag_updated(self, data):
    #    print("-------collision_flag------------")
    #    print(data)
    #    self.collision_flag = data
    ...
    def twist_command_updated(self, twist):
        ...
        """
        #print("set angular/linear velocity")
        #print(twist)
        ...
        #print(rotated_linear_vector)
        linear_velocity.x = rotated_linear_vector[0] #s
